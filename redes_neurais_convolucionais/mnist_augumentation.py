#Aumenta a quantidade de imagens
...
# Efetua o pre processamento de imagens. Interessante de usar quando nao se tem muitas imagens de um tipo
...
gerador_treinamento = ImageDataGenerator(rotation_range=7,
                                         ...
                                         zoom_range=0.2)
#Quando nao passa parametro, nao altera as propriedades da imagem
gerador_teste = ImageDataGenerator()

#O batch size fica agora aqui na geracao da base
